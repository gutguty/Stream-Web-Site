...
class Tabs extends BaseComponent {
  ...
  constructor(rootElement) {
    ...
    this.navigationElemnt = this.params.navigationTargetElementId
      ? document.getElementById(this.params.navigationTargetElementId)
      : this.rootElement.querySelector(this.selectors.navigation)
    this.buttonElements = [...this.navigationElemnt.querySelectorAll(this.selectors.button)]
  ...
  updateNavigationCSSVars(
    ...
    const offsetLeft = left - this.navigationElemnt.getBoundingClientRect().left

    this.navigationElemnt.style.setProperty(
  ...
  onKeyDown = (event) => {
    ...
    const isTabsButtonsFocused = this.buttonElements.some((buttonElement) => buttonElement === target)

    if (!isTabsButtonsFocused && !isTabsContentFocused) {
      return
    }
  ...
  bindObservers = () => {
    ...
    resizeObserver.observe(this.navigationElemnt)
  }
}

    ...
    <div className="select" data-js-select="">
      ...
      <div className="select__body">
        <div
          ...
          role="combobox" // Я комбинированный список
          aria-expanded={false} // Сейчас я закрыт
          aria-haspopup="listbox" // У меня есть выпадающий список
          aria-controls={IDs.dropdown}  //Я управляю этим элементом
          aria-labelledby={IDs.label}  // Моя метка вот здесь
          tabIndex={0} // Я доступен с клавиатуры
